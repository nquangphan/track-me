package com.phannhatquang.trackme.services;
...
import com.phannhatquang.trackme.ui.maps.view.MapsActivity;
...
public class LocationUpdatesService extends Service {
    ...
    private static final String PACKAGE_NAME =
            "com.phannhatquang.trackme";

    private static final String TAG = LocationUpdatesService_.class.getSimpleName();
    ...
    private Notification getNotification() {
        Intent intent = new Intent(this, LocationUpdatesService_.class);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .addAction(R.drawable.common_google_signin_btn_icon_dark, getString(R.string.app_name),
                        activityPendingIntent)
                .addAction(R.drawable.common_full_open_on_phone, getString(R.string.common_google_play_services_unknown_issue),
